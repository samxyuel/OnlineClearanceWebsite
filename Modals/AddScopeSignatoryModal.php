    ...
    <div class="modal-window">
        ...
        <div class="modal-content-area">
            ...
            <div class="form-group">
                <label for="scopeSearchInput">Search Designation</label>
                <input type="text" id="scopeSearchInput" class="form-control" placeholder="e.g., Cashier or Guidance" oninput="debouncedScopeSearch()">
            </div>
            <div class="form-group">
                <div id="scopeSearchResults" class="scope-results-list"></div>
            </div>
            <div class="form-group">
                <label>Selected Designations</label>
                ...
                <div id="scopeAllStaffTableWrap" class="scope-all-staff-wrap">
                    <table class="scope-all-staff-table">
                        ...
                        <tbody id="scopeAllStaffTable">
                            <tr class="placeholder"><td colspan="2">Loading…</td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
