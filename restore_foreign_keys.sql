-- =====================================================
-- RESTORE FOREIGN KEYS ONLY
-- Online Clearance Database - Foreign Key Restoration
-- =====================================================
-- This script restores all foreign key constraints
-- Run this after importing basedata_db.sql
-- =====================================================
...
SELECT '====================================================';
SELECT 'FOREIGN KEYS RESTORED SUCCESSFULLY!';
SELECT '====================================================';

SELECT 'Total Foreign Keys Restored:' as Info, COUNT(*) as Count
FROM information_schema.KEY_COLUMN_USAGE
WHERE TABLE_SCHEMA = 'basedata_db' 
  AND REFERENCED_TABLE_NAME IS NOT NULL;

SELECT '====================================================';
SELECT 'Foreign Keys by Table:';
SELECT '====================================================';
