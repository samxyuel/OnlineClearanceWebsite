...
function handleRejectOperation($connection, $userId, $input) {
    ...
    $stmt = $connection->prepare("
        UPDATE clearance_signatories 
        SET action = 'Rejected', remarks = ?, reason_id = ?, additional_remarks = ?, updated_at = NOW(), actual_user_id = NULL, signatory_first_name = NULL, signatory_last_name = NULL, date_signed = NULL 
        WHERE signatory_id = ? AND clearance_form_id = ?
    ");
    $result = $stmt->execute([null, $rejectionReasonId, $remarks, $signatoryId, $clearanceFormId]);
...
function handleBulkRejectOperation($connection, $userId, $input) {
    ...
    foreach ($targetUserIds as $index => $targetUserId) {
        ...
        try {
            ...
            $stmt = $connection->prepare("
                UPDATE clearance_signatories 
                SET action = 'Rejected', remarks = NULL, reason_id = ?, additional_remarks = ?, updated_at = NOW(), actual_user_id = NULL, signatory_first_name = NULL, signatory_last_name = NULL, date_signed = NULL 
                WHERE signatory_id = ? AND clearance_form_id = ?
            ");
            $result = $stmt->execute([$rejectionReasonId, $remarks, $signatoryId, $clearanceFormId]);
