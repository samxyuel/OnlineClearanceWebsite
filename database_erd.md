...
- **sector_signatory_assignments**: Pre-configured signatory assignments per sector
- **sector_clearance_settings**: Settings for each sector (Required First/Last)
...
3. **Sector Signatory Assignments** → **Clearance Signatories** (per form)
...
- **Regular Staff**: Assigned to sectors via `sector_signatory_assignments`
- **Program Heads**: Department-specific assignments
- **Required First/Last**: Special signatory ordering via `sector_clearance_settings`
...
This ERD represents a comprehensive clearance management system with sector-based workflows, role-based access control, and automated form distribution based on signatory assignments.
