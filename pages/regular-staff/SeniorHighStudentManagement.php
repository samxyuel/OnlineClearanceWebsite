...
try {
    ...
    if (!empty($userDesignations)) {
        // 2. Check which of these designations are assigned to sign for 'Senior High School' students
        ...
        $studentSignatoryCheck = $pdo->prepare("
            ...
            WHERE designation_id IN ($placeholders) AND clearance_type = 'Senior High School' AND is_active = 1
        ");
