-- =====================================================
-- Final Staff Format Update Migration
-- Date: 2025-01-27
-- Purpose: Properly update staff table structure and data to LCAXXXXP format
-- =====================================================

START TRANSACTION;

-- =====================================================
-- 1. REMOVE ALL EXISTING CONSTRAINTS AND COMMENTS
-- =====================================================
...
-- Modify the employee_number column to remove the old format comment
ALTER TABLE staff MODIFY COLUMN employee_number VARCHAR(8) NOT NULL COMMENT 'Employee Number format: LCAXXXXP';
...
-- =====================================================
-- 5. ADD NEW FORMAT VALIDATION CONSTRAINTS
-- =====================================================
...
SELECT 'Final Staff and Faculty Format Update Completed Successfully!' as message;
