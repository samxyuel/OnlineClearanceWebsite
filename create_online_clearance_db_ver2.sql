-- =====================================================================
-- Online Clearance System Database - Version 2
-- Database: online_clearance_db_ver2
-- Description: Sector-based clearance period system for Students and Faculty
-- Sectors: Senior High School, College, and Faculty
-- =====================================================================

-- Drop existing database if it exists (to ensure clean creation)
DROP DATABASE IF EXISTS `online_clearance_db_ver2`;

-- Create database
CREATE DATABASE `online_clearance_db_ver2` 
DEFAULT CHARACTER SET utf8mb4 
COLLATE utf8mb4_unicode_ci;

-- Use the database
USE `online_clearance_db_ver2`;
...
SELECT 'Database online_clearance_db_ver2 created successfully!' as Message;
